...
public class FireBehaviour : StateMachineBehaviour
{
    ...
    // OnStateEnter is called when a transition starts and the 
    ...
    // OnStateExit is called when a transition ends and the 
    //state machine finishes evaluating this state
